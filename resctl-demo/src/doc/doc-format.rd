...
%% on sideload test-build build-linux-half     : [ Start a linux build sideload ]
%% off sideload test-build                     : [ Stop a linux build sideload ]
%% toggle sideload test-build build-linux-half : Toggle a linux build sideload
...
%% on sysload test-build build-linux-half      : [ Start a linux build sysload ]
%% off sysload test-build                      : [ Stop a linux build sysload ]
%% toggle sysload test-build build-linux-half  : Toggle a linux build sysload
%%
